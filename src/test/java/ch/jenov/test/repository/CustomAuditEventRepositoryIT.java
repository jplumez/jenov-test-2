...
import static ch.jenov.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

import ch.jenov.test.JenovTest2App;
import ch.jenov.test.config.Constants;
import ch.jenov.test.config.audit.AuditEventConverter;
import ch.jenov.test.domain.PersistentAuditEvent;
