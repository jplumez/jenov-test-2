...
import static ch.jenov.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import ch.jenov.test.JenovTest2App;
import ch.jenov.test.config.Constants;
import ch.jenov.test.domain.User;
import ch.jenov.test.repository.AuthorityRepository;
import ch.jenov.test.repository.UserRepository;
import ch.jenov.test.security.AuthoritiesConstants;
import ch.jenov.test.service.UserService;
import ch.jenov.test.service.dto.PasswordChangeDTO;
import ch.jenov.test.service.dto.UserDTO;
import ch.jenov.test.web.rest.vm.KeyAndPasswordVM;
import ch.jenov.test.web.rest.vm.ManagedUserVM;
