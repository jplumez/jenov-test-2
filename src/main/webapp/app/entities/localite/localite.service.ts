...
type EntityResponseType = HttpResponse<ILocalite>;
type EntityArrayResponseType = HttpResponse<ILocalite[]>;

@Injectable({ providedIn: 'root' })
export class LocaliteService {
  public resourceUrl = SERVER_API_URL + 'api/localites';
  ...
  update(localite: ILocalite): Observable<EntityResponseType> {
    return this.http.put<ILocalite>(this.resourceUrl, localite, { observe: 'response' });
  }
