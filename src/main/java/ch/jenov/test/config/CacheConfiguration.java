...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.jenov.test.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.jenov.test.repository.UserRepository.USERS_BY_EMAIL_CACHE);
